...
- GitHub Releases 由来の `hlkx.r` / `has060x.x` / `u8tosj.r` を取得する `tools/setup_human68k_binaries.sh` を追加し、初回回帰実行を実施した（結果は `docs/porting/2026-02-27-regression-first-run.md`）。
